...
<template>
    <NuxtLink :to="cta?.link || '#'" :style="cardBgStyle" class="flex flex-col relative group gap-2 justify-center text-primary-blue rounded-3xl sm:px-8 sm:gap-4 w-full bg-[var(--card-bg-light)] dark:bg-[var(--card-bg-dark)] relative">
